...
function obtenerMayor(x, y) {
   ...
   // Tu código:
   if ( x > y || x === y) return (x); else return (y)
}
...
function mayoriaDeEdad(edad) {
   ...
   // Tu código:
   if (edad > 18 || edad === 18) return ("Allowed"); else return ("Not allowed")
}
...
function fizzBuzz(num) {
   ...
   // De lo contrario, retorna false.
   // Tu código:
  if (num % 3 === 0 && num % 5 === 0) return ("fizzbuzz"); else if (num % 5 === 0) return ("buzz"); else if (num % 3 === 0) return ("fizz"); else return false
}
