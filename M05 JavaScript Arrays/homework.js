...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   let palabrasSeparadas = palabras.join(" ")
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let sum1 =arrayOfNums.reduce((anterior, actual) => anterior + actual, 0);
   return sum1;
...
function diaDeLaSemana(numeroDeDia) {
   ...
   // Tu código:
   if (numeroDeDia> 1 && numeroDeDia < 7) return "Es dia laboral"; else return "Es fin de semana";
